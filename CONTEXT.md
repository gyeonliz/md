...
- 이 PC의 Unreal 프로젝트: `C:\URproject\drone`
- 이 PC의 문서 저장소: `C:\Users\jkw11\Documents\Codex\2026-08-19\codex-gpt-chatgpt-codex-1-6`
- 다른 PC의 클론 경로는 이 문서의 절대 경로를 그대로 사용하지 말고 해당 PC에서 확인한다.
...
- `/Game/Drone/Maps/TestMap/Lvl_DroneShotgunSystemsTest`: 기존 AI 맵의 순찰·MG 경합을 건드리지 않고 추가 Shotgun NPC의 감지·산탄 Projectile·탄약을 보는 독립 시험 맵이다.
- `/Game/Drone/Maps/TestMap/Lvl_DroneWeatherSystemsTest`: LightWind 지속풍·돌풍과 조작 모드별 보정 체감 전용 맵이다. 비 시각 효과가 구현된 맵으로 표현하지 않는다.
...
- Rate/Acro Mode 2 축은 오른쪽 Stick Pitch/Roll, 왼쪽 세로 Throttle, 왼쪽 가로 Yaw다. 키보드·마우스는 개발용 대체 입력이다.
