...
마지막 갱신: 2026-09-16 — 기상 Profile·지속풍/돌풍 Runtime·전용 TestMap 완료
...
| AI-SO-TUNE-01 | Smart Object·유인 MG 화면 확인 | 맵을 TestMap으로 이동, Asset·PIE·감지/수색 자동화 통과 | 이동된 AI 시험 맵에서 방향·정렬·Gaze·재점유 확인 |
| AI-SHOTGUN-PIE-01 | 추가 Shotgun NPC 사격 체감 확인 | 독립 사격장·추가 NPC·Asset/PIE 자동화·Map Check 완료 | Cyan Pellet 원뿔·회피·피해·사거리·LOS를 Editor 화면에서 확인 |
...
| WTH-02-PIE-01 | 바람 Vertical Slice 체감 | Profile/Snapshot/Subsystem·Drone Response·전용 TestMap·자동화 완료 | 쉬운 조작/Rate-Acro Drift, 순풍·역풍·횡풍과 돌풍 세기 화면 확인 |
...
- `/Game/Drone/Maps/TestMap/Lvl_DroneShotgunSystemsTest`: 추가 Shotgun NPC·산탄 Projectile·탄약·LOS 사격장
- `/Game/Drone/Maps/TestMap/Lvl_DroneWeatherSystemsTest`: LightWind 지속풍·돌풍·조작 모드별 보정, 풍향 화살표

## Next

1. 수동 확인에서 발견된 Gate/HUD/역할 결함 수정 후 TestMap 회귀
2. Shotgun Systems 맵에서 Cyan 원뿔·회피 가능 탄속·피해·사거리·LOS를 수동 확인
...
6. Weather Systems 맵에서 쉬운 조작/Rate-Acro Drift와 LightWind 돌풍을 수동 확인
