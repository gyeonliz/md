...
4. [`docs/MOBILE_CURRENT_BRIEF.md`](../../../learning/MOBILE_CURRENT_BRIEF.md): 이동 중 읽는 코드 현황·내 작업·공식 시험 일정·날짜별 공부 계획
5. [`docs/DRONE_WORKLOG.md`](../../DRONE_WORKLOG.md): 현재 작업 위치와 날짜별 변경·검증·다음 작업 기록
6. [`docs/DRONE_CODE_STRUCTURE_AND_USER_TASKS.md`](../../../reference/DRONE_CODE_STRUCTURE_AND_USER_TASKS.md): 현재 코드·Asset 책임, 구현 경계와 사용자가 직접 확인할 작업
7. [`docs/GIT_UNREAL_GUIDE.md`](../../../git/GIT_UNREAL_GUIDE.md): Unreal 프로젝트 Git/GitHub 실전 절차
8. [`docs/CODEX_CONTEXT_SYNC.md`](../../../git/CODEX_CONTEXT_SYNC.md): 메인컴 ↔ 작업컴 문맥 전달 절차
9. [`docs/DRONE_PROJECT_AUDIT.md`](../../DRONE_PROJECT_AUDIT.md): 현재 후보 프로젝트의 실제 C++·입력·맵 구조 감사
10. [`docs/DRONE_PROTOTYPE_IMPLEMENTATION.md`](../../../tutorial/DRONE_PROTOTYPE_IMPLEMENTATION.md): 실제 C++ Prototype 구현·검증과 Editor 연결 절차
11. [`docs/DRONE_PROTOTYPE_INPUT_CONTRACT.md`](../../../tutorial/DRONE_PROTOTYPE_INPUT_CONTRACT.md): 현재 Prototype 전용 임시 입력 계약
12. [`docs/DRONE_PROTOTYPE_PIE_CHECKLIST.md`](../../../tutorial/DRONE_PROTOTYPE_PIE_CHECKLIST.md): PFN-06 자동화 결과와 수동 화면 체크리스트
13. [`docs/DRONE_TELEMETRY_IMPLEMENTATION.md`](../../../tutorial/DRONE_TELEMETRY_IMPLEMENTATION.md): HUD-01 Snapshot 공급과 HUD-02 Flight HUD 구현·검증
14. [`docs/DRONE_TRAINING_RECORDING_IMPLEMENTATION.md`](../../../tutorial/DRONE_TRAINING_RECORDING_IMPLEMENTATION.md): TUT-03 구간·랩 기록 구조, Blueprint 연결점과 검증 절차
15. [`docs/DRONE_PREASSET_FUNCTION_PLAN.md`](../../../planning/DRONE_PREASSET_FUNCTION_PLAN.md): 구매 소스 없이 Greybox 기능을 먼저 완성하는 실행 계획
16. [`docs/DRONE_MVP_GUIDE.md`](../../../planning/DRONE_MVP_GUIDE.md): Flight MVP부터 데모까지의 개발 단위
17. [`docs/DRONE_SMART_OBJECT_NPC_GUIDE.md`](../../../ai/DRONE_SMART_OBJECT_NPC_GUIDE.md): 적 순찰·드론 감지·Rifle/Shotgun·MG와 기지 아군 Smart Object 이동 준비·사용 절차
18. [`docs/DRONE_SMART_OBJECT_ROUTE_EDITING_GUIDE.md`](../../../ai/DRONE_SMART_OBJECT_ROUTE_EDITING_GUIDE.md): 팀 공유용 Smart Object 지점 이동·복제·방향·NavMesh·StateTree·유인/무인 포탑 구분 가이드
19. [`docs/WORK_MANAGEMENT.md`](../../../planning/WORK_MANAGEMENT.md): Inbox → Todo → Doing → Done 운영
20. [`docs/DRONE_FRONTEND_MISSION_FLOW_PLAN.md`](../../../planning/DRONE_FRONTEND_MISSION_FLOW_PLAN.md): 시작 트레일러·로비·미션 선택·브리핑·Map·Drone 선택·목표 UI의 최신 최우선 흐름
21. [`docs/DRONE_TUTORIAL_STORY_PLAN.md`](../../../planning/DRONE_TUTORIAL_STORY_PLAN.md): 확정 조작, Tutorial 코스·기록 UI, Mission·Jamming·에셋 적용 계획
22. [`docs/DRONE_ASSET_INTAKE_2026-08-25.md`](../../../assets/DRONE_ASSET_INTAKE_2026-08-25.md): 최초 D 드라이브 14팩 압축 감사, 다른 PC의 C 드라이브 재감사와 FPV·Loop 선별 이식 검증
23. [`docs/DRONE_REMAINING_ASSET_MIGRATION_2026-08-27.md`](../../../assets/DRONE_REMAINING_ASSET_MIGRATION_2026-08-27.md): 남은 제공 자산 891개·OilRig 중앙 맵·TUT-04B 이식 및 검증
24. [`docs/DRONE_UNREAL_MCP.md`](../../../git/DRONE_UNREAL_MCP.md): UE 5.8 공식 Unreal MCP·Codex 연결, 선택 Toolset과 검증 기준
25. [`docs/DRONE_CHAOS_DATAFLOW_PLAN.md`](../../../gameplay/DRONE_CHAOS_DATAFLOW_PLAN.md): UE 5.8 Dataflow 기반 부분 고정 그물·선택형 맵 파괴 설계와 검증 순서
26. [`docs/UNREAL_PROJECT_EXPERIENCE_DESCRIPTION.md`](../../../learning/UNREAL_PROJECT_EXPERIENCE_DESCRIPTION.md): 지원서·이력서용 Unreal 프로젝트 경험 기술 예시와 사실 확인 경계
27. [`docs/STUDY_PLANS.md`](../../../learning/STUDY_PLANS.md): 정보처리산업기사·C++ 코딩테스트 병행 계획
28. [`docs/DRONE_PROJECT_PLANNING_BRIEF.md`](../../../planning/DRONE_PROJECT_PLANNING_BRIEF.md): 게임 기획·화면 흐름·UI·현재 구현·로드맵·검증을 한 문서로 정리한 통합 기획서
29. [`docs/DRONE_TRELLO_BOARD_2026-09-09.md`](../../DRONE_TRELLO_BOARD_2026-09-09.md): Trello에 복사할 완료·수동 확인·다음 개발·장기 후보 카드와 체크리스트
30. [`docs/EXTERNAL_ENGINEERING_REFERENCES/README.md`](../../../reference/external-engineering/README.md): Ponytail·ECC·Archify·fmt·Matt Pocock Skills 검토와 Drone 팀 적용 기준
31. [`docs/DRONE_GIT_LFS_CAPACITY_PLAN.md`](../../../git/DRONE_GIT_LFS_CAPACITY_PLAN.md): 실제 27.66GiB LFS 분포, 크기 Threshold의 한계와 Core/선택형 Asset 분리·선택 Clone·원격 정리 계획
32. [`docs/CS_GAMEDEV_READING_PLAN.md`](../../../learning/CS_GAMEDEV_READING_PLAN.md): 게임 Pattern·선형대수·OS·Interpreter·그래픽스·네트워크·AI/NLP 추천자료 8종의 장기 병행 학습 순서와 기록 양식
...
2026-09-15 로컬 후속 변경은 유인 MG 1개와 차량형/설치형 무인 자동포탑 2종을 테스트에서 명확히 분리하고, 사수 사망 뒤 재할당 재시도와 이동 정체 감시·재경로·조작 위치 정렬을 보강했다. 현재 Smart Object 순찰은 Actor 번호나 Spline 순서가 아니라 태그가 맞는 최근접 빈 Slot을 선택한다. 팀 배치 절차는 [`docs/DRONE_SMART_OBJECT_ROUTE_EDITING_GUIDE.md`](../../../ai/DRONE_SMART_OBJECT_ROUTE_EDITING_GUIDE.md)를 따른다.
...
외부 제공 소스는 전체 팩을 흡수하지 않고 검증된 대표 자산과 정확한 의존성만 ThirdParty 경계로 선별 이식했다. 기능 구현은 계속 프로젝트 C++와 Greybox 기준을 유지하며 외부 Pawn·GameMode·Input은 사용하지 않는다. 현재 신규 기능 실행 순서는 [`DRONE_FRONTEND_MISSION_FLOW_PLAN.md`](../../../planning/DRONE_FRONTEND_MISSION_FLOW_PLAN.md)가 우선하고 Tutorial·PFN 카드 번호와 교체 경계는 기존 계획 문서를 함께 따른다.

2026-08-25에는 UE 5.8.1에 포함된 Epic 공식 `Unreal MCP`를 프로젝트에 Editor 전용으로 연결했다. 전체 `AllToolsets` 대신 Editor·Automation·UMG·StateTree·AI Toolset만 선택했고, Codex 프로젝트 설정과 자동 시작 기본값을 추가했다. 연결 당시 실제 HTTP MCP 초기화, 23개 Toolset, Training Map 조회와 당시 12개 Drone 테스트 탐색까지 통과했다. 상세 기준은 [`docs/DRONE_UNREAL_MCP.md`](../../../git/DRONE_UNREAL_MCP.md)를 따른다.
...
프로젝트 사용 맵은 `/Game/Drone/Maps`로 중앙화했다. Unreal 생성 기본 Map 4개만 제거했고 ThirdPerson·Variant 비맵 콘텐츠 62개는 복구했다. 환경 맵 3종은 중앙 사본으로 두되 대형 공급사 의존성 Root는 참조 안정성을 위해 보존했다. RabbitHole 참고 근거, 현재 폴더 트리, 삭제 경계와 검증 결과는 [`docs/DRONE_CONTENT_FOLDER_GUIDE.md`](../../../assets/DRONE_CONTENT_FOLDER_GUIDE.md)에 정리했다.
