...
NPC·AI 다음 작업을 위해 Smart Objects와 Gameplay Interactions 모듈, Faction·Rifle·Shotgun Profile, Activity Tag, NPC Character/Controller/Spawn Point, Slot 예약 Component와 드론 Sight 감지 기반을 준비했다. 이어서 Smart Object Definition 6종과 대응 Station Blueprint 6종을 실제 생성해 Slot·Activity·Definition·MG Mesh 연결을 검증했다. 전체 `Drone.` 18/18, Blueprint 0/0/0과 LFS 검사를 통과했다. Interaction StateTree와 실제 순찰·아군 이동·사격은 아직 미구현이며 [`docs/DRONE_SMART_OBJECT_NPC_GUIDE.md`](docs/DRONE_SMART_OBJECT_NPC_GUIDE.md)의 `AI-NPC-01`부터 진행한다.
